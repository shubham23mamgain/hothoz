...
import { deleteCategory, getCategory } from '../../../features/actions/sides/categorySides'
...
const Category = () => {
    ...
    const {isDeleted,categoryData,isLoading } = useSelector(state => state.sidesCategory)
  
    
    const handleAddCategory = () => {
      navigate('/createSidesCategory');
      };
                 ...
                 Array.isArray(categoryData) && categoryData.length > 0 && categoryData?.map((item, idx) => (
                    <tr key={idx}>
                      ...
                      <td className=" whitespace-nowrap">
                        <a
                          onClick={() => {
                            navigate(`/updateSidesCategory/${item?._id}`, { state: item  });
                          }}
